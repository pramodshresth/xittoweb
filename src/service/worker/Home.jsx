...
import {token,Pending ,UpdateStatus,Ongoing, Completed,Appoint} from '../../api/ApI';
...
<div className="tab-content" id="myTabContent">
  ...
  <div className="tab-pane fade" id="appoint" role="tabpanel" aria-labelledby="appoint-tab">
  {
          
          appoint===undefined?"":appointaccordingtocategory.map((item,index)=>(
              <>
              <div key={index} className='row'>
               <div className='col-md-12'>
              <div className='onworkpage '>
